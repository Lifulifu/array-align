...
def meta_train(model, meta_dataset, meta_start_epoch=1, meta_epochs=1000,
               task_epochs=10, task_tr_size=5, task_te_size=32,
    ...
    for epoch in tqdm(
        ...
        new_model, meta_tr_loss, ypred = train_task(
            model, xtr, xte, ytr, yte, epochs=task_epochs, device=device)
